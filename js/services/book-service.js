...
function getById(bookId) {
  ...
  //  const selectedBook=gBooks.find(book=>{return bookId===book.id})
  //  return selectedBook
}
...
function removeReview(bookId, reviewId) {
  return storageService.get(BOOKS_KEY, bookId)
    .then(book => {
      ...
      if (idx === -1) return Promise.reject('err')
